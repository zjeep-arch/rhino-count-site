...
window.SITE_DATA = {
  ...
  lab: {
    ...
    featured: [
      {
        type: "Essay",
        title: "a16z播客全文整理：AI正在重写风投的幂律——3000家机构里及格的只有20家",
        desc: "The a16z Show《How AI Is Rewriting the Power Law of Venture Capital》全文整理（2026-09-10，全期49分钟）。3000家美国风投过去二十年只有20家做到持续3倍净回报；资本第一次能直接换算力、复利放大优势；AI收入4年干到1000亿，SaaS用了15年；遗留SaaS账算不回来；真正的瓶颈在供给端——能源、电网、数据中心。含与微信评论文章的逐条校对说明。",
        href: "notes/2026-09-18-a16z幂律播客.html"
      },
      {
        type: "Essay",
        title: "朱啸虎北大演讲全文整理：技术会平权，重要的永远是人文和商业",
        desc: "朱啸虎2026年9月16日北大分享全文整理。二十年风投看AI：三个S标准、流量高地、社区平台产品金字塔、滴滴易到案例、高频打低频、技术扩散后发优势、开源终局与AI应用的情绪价值机会，含与王小川现场对谈：技术派还是市场派、方向盘还是发动机。",
        href: "notes/2026-09-17-朱啸虎北大分享.html"
      },
      {
        type: "Essay",
    ...
    notes: [
      {
        cat: "观察", num: "N° 98",
        title: "a16z播客全文整理：AI正在重写风投的幂律——3000家机构里及格的只有20家",
        excerpt: "a16z这期播客把AI时代的钱讲透了：3000家美国风投过去二十年只有20家持续做到3倍净回报，不到1%。资本第一次能直接换算力复利放大优势，AI收入4年干到1000亿、SaaS用了15年，旧SaaS的账算不回来，真正的瓶颈在供给端。含与微信评论文章的逐条校对说明。",
      ...
      },
      {
        cat: "观察", num: "N° 97",
        title: "朱啸虎北大演讲全文整理：技术会平权，重要的永远是人文和商业",
        excerpt: "朱啸虎9月16日北大分享全文整理。技术会平权，重要的是人文和商业：三个S标准、滴滴易到从出租车切入、技术扩散后发优势、开源终局、AI情绪价值与角色扮演的机会，含与王小川现场对谈——技术派还是市场派、方向盘还是发动机。",
        img: "assets/note-05.svg",
        href: "notes/2026-09-17-朱啸虎北大分享.html"
      },
      {
